...
//   // Anropa addOne-funktionen
//   addOne();

//   // Skapa en ny instans av NewBostad-klassen
//   var newBostad = new NewBostad();
//   newBostad.someMethod();
// });
...
function saveBostad () {
  ...
  $( document ).ready( function () {
    var newBostad = new NewBostad
    newBostad.someMethod();
    const bostad = new NewBostad( type, address, city, price, rooms, area, balcony, floor, elevator, year, storehouse, parking, garden, name, lastName, email, phone )
